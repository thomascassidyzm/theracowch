...
(function () {
  ...
  function build() {
    ...
    gate.innerHTML = [
      ...
      '<p>Your answers are kept on this device and are not sent anywhere. If you finish &ldquo;What are you like, anyway?&rdquo;, its six results go with your messages to Mandy &mdash; you can switch that off.</p>',
