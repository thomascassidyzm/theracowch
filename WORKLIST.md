...
- [~] @claude-telemetry-scout 08-27 **Telemetry reality + the route to Mandy — SCOUT (map only, no building).** What we actually capture, what Vercel can aggregate for testers, where the "what are you like, anyway?" answers live, and the delivery route for a consented feed to Mandy. → `docs/telemetry-reality.md`
